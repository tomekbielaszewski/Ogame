package org.grizz.i18n;

public class Localization {
    public static final String EXCEPTION_VALIDATION = "exception.validation";
    ...
    public static final String VALIDATION_USER_PASSWORD_NOTNULL = "validation.user.password.notnull";
    public static final String VALIDATION_USER_PASSWORD_SIZE = "validation.user.password.notnull";
}
